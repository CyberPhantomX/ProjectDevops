#!/bin/bash
 ...
 wget https://github.com/prometheus/prometheus/releases/download/v2.47.1/prometheus-2.51.1.linux-386.tar.gz
 tar -xvf prometheus-2.51.1.linux-386.tar.gz
 ...
 cd
 rm -rf prometheus-2.51.1.linux-386.tar.gz
